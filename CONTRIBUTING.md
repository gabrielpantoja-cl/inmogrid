...
2. Revisá los [issues abiertos](https://github.com/gabrielpantoja-cl/inmogrid.cl/issues). Si vas a trabajar en algo, comentá en el issue correspondiente o abrí uno nuevo para discutir el enfoque antes de mandar código.
