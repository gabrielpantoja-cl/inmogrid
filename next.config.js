...
const nextConfig = {
  ...
  async headers() {
    const cspHeader = `
      ...
      connect-src 'self' https://*.supabase.co wss://*.supabase.co https://www.google-analytics.com https://www.googletagmanager.com https://vercel.live/ https://vitals.vercel-insights.com https://api.openai.com https://api.github.com https://referenciales.cl https://www.referenciales.cl ws://127.0.0.1:* ws://localhost:*;
