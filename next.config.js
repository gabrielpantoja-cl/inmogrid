...
const nextConfig = {
  ...
  async headers() {
    const cspHeader = `
      ...
      img-src 'self' blob: data: https://*.googleusercontent.com https://*.tile.openstreetmap.org https://degux.cl https://www.degux.cl https://images.unsplash.com https://ui-avatars.com https://*.supabase.co https://blog-assets.pantojapropiedades.cl;
      font-src 'self' data:;
      object-src 'none';
      base-uri 'self';
      form-action 'self';
      frame-ancestors 'none';
      connect-src 'self' https://www.google-analytics.com https://www.googletagmanager.com https://vercel.live/ https://vitals.vercel-insights.com https://api.openai.com https://api.github.com https://referenciales.cl https://www.referenciales.cl ws://127.0.0.1:* ws://localhost:*;
