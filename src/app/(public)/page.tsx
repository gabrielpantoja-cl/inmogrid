...
/**
 * Landing de inmogrid.cl: feed público de publicaciones de la comunidad.
 * La navegación, login/logout y menú de cuenta los provee `PublicHeader`
 * desde `src/app/(public)/layout.tsx` — esta página solo renderiza el feed.
 */
    ...
    <main className="max-w-4xl mx-auto px-4 md:px-8 py-10">
      <div className="mb-8">
        ...
        <p className="mt-1 text-gray-500">
          Ideas, conocimiento y experiencias de la comunidad INMOGRID.
        </p>
      </div>
