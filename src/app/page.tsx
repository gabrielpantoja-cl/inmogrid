      ...
      <div className="mt-16 mb-8 flex justify-center">
        <div className="w-full max-w-sm">
          ...
          <a
            ...
            target="_blank"
            rel="noopener noreferrer"
            className="group bg-white rounded-lg shadow-md border border-gray-200 p-6 hover:shadow-xl hover:border-primary/50 transition-all transform hover:-translate-y-1 flex flex-col items-center text-center gap-4"
          >
            ...
            <div>
              ...
              <p className="text-gray-600 text-sm">
                Explora el código fuente y contribuye en GitHub.
              </p>
            </div>
            <div className="mt-2 flex items-center gap-2 text-primary group-hover:gap-3 transition-all">
              <span className="font-medium text-sm">Ver en GitHub</span>
