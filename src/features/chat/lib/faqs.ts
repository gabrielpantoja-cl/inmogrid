/**
 * Preguntas frecuentes de Sofia (chatbot de inmogrid.cl) y respuestas cacheadas.
...
export const faqs: Record<string, string> = {
  '¿De qué se trata inmogrid.cl?':
    'inmogrid.cl es una plataforma colaborativa para profesionales del ecosistema inmobiliario chileno. Publica contenido, crea tu perfil profesional y conecta con otros corredores, tasadores, arquitectos e inversores.',
  '¿Cómo puedo registrarme?':
    'Al iniciar sesión con Google te registras automáticamente en inmogrid.cl y puedes comenzar a crear tu perfil profesional.',
  ...
  '¿Cuál es el canal de contacto?':
    'Puedes contactarnos a traves de nuestras Discusiones en GitHub: https://github.com/gabrielpantoja-cl/inmogrid.cl/discussions',
};
