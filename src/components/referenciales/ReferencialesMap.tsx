...
import type { Referencial } from '@/lib/referenciales-api';
...
export default function ReferencialesMap({
  ...
  return (
    ...
    >
      <TileLayer
        attribution='&copy; <a href="https://www.openstreetmap.org/copyright">OpenStreetMap</a> contributors &middot; datos: <a href="https://referenciales.cl">referenciales.cl</a>'
