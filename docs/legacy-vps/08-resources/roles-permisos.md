...
This document describes the role-based access control (RBAC) system implemented for inmogrid.cl. The system allows only admin users to perform CRUD operations and view sensitive buyer/seller data.
...
- `/dashboard/inmogrid/create`
- `/dashboard/inmogrid/edit`
- `/api/inmogrid/create`
- `/api/inmogrid/update`
- `/api/inmogrid/delete`
- `/api/inmogrid/upload-csv`
...
#### Table Component (`src/components/ui/inmogrid/table.tsx`)
- Conditionally shows/hides sensitive buyer/seller data
- Redacts data for non-admin users with "• • • • •"

#### Dashboard Page (`src/app/dashboard/inmogrid/page.tsx`)
...
- ✅ `src/components/ui/inmogrid/table.tsx` - Conditional data display
- ✅ `src/app/dashboard/inmogrid/page.tsx` - Admin UI elements
- ✅ `src/app/api/inmogrid/upload-csv/route.ts` - API protection
