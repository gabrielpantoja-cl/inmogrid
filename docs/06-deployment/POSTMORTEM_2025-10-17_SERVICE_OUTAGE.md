...
✅ https://n8n.gabrielpantoja.cl          HTTP 200 OK
...
| n8n.gabrielpantoja.cl | n8n:5678 | ✅ Valid | 🟢 200 OK |
...
| **n8n.gabrielpantoja.cl** | ❌ Offline (502) | ~15 min | Workflows detenidos, UI inaccesible |
...
ssh gabriel@167.172.251.27 "docker ps -a"

# 2. Verificar docker-compose files
ssh gabriel@167.172.251.27 "ls -la ~/vps-do/docker-compose*.yml"
ssh gabriel@167.172.251.27 "cat ~/vps-do/docker-compose.yml"
ssh gabriel@167.172.251.27 "cat ~/vps-do/docker-compose.degux.yml"

# 3. Verificar Nginx nativo
ssh gabriel@167.172.251.27 "systemctl status nginx"
ssh gabriel@167.172.251.27 "ss -tulpn | grep :80"
...
ssh gabriel@167.172.251.27 "cd ~/vps-do && docker-compose -f docker-compose.n8n.yml up -d"

# 2. Levantar degux-web
ssh gabriel@167.172.251.27 "cd ~/vps-do && docker-compose -f docker-compose.n8n.yml -f docker-compose.degux.yml up -d degux-web"

# 3. Levantar Portainer
ssh gabriel@167.172.251.27 "docker start 605f0f38f466_portainer"

# 4. Verificaciones
ssh gabriel@167.172.251.27 "curl http://localhost:3000/api/health"
ssh gabriel@167.172.251.27 "curl -s -o /dev/null -w '%{http_code}' https://degux.cl/"
ssh gabriel@167.172.251.27 "docker ps --format 'table {{.Names}}\t{{.Status}}'"
```
